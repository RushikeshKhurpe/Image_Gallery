...
/* Api to update Image */
app.post("/update-Image", upload.any(), (req, res) => {
  try {
    if (req.files && req.body && req.body.name && req.body.desc &&
      req.body.id) {

      Image.findById(req.body.id, (err, new_Image) => {
...
app.post("/delete-Image", (req, res) => {
  try {
    if (req.body && req.body.id) {
      Image.findByIdAndUpdate(req.body.id, { is_delete: true }, { new: true }, (err, data) => {
        if (data.is_delete) {
          res.status(200).json({
            status: true,
            title: 'Image deleted.'
...
/*Api to get and search Image with pagination and search by name*/
app.get("/get-Image", (req, res) => {
  try {
    ...
    Image.find(query, { date: 1, name: 1, id: 1, desc: 1, image: 1 })
